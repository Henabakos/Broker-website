...
import { Card_Data_Sell } from "../index.js";
...
const ForSale = () => {
  ...
  return (
    <div>
      <Navbar />
      <div className="bg-hero-pattern bg-cover bg-center h-[50vh]   lg:h-screen flex items-center justify-center text-center ">
        <div className="bg-black/60 h-full w-full flex flex-col items-center justify-center">
